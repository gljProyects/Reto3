...
public class GestorBBDD {
	...
	public void insertarEntradaCliente(Entrada entradaParaRegistrar) {
		...
		try {
			...
			String sql = "insert into entrada (dni_cliente,cod_emision,fecha_compra) VALUES ('"	+ entradaParaRegistrar.getCliente().getDni() + "', '"
	...
	public void insertarEntradaClienteTest(Entrada entradaParaRegistrar) {
		...
		try {
			...
			String sql = "insert into entrada (cod_entrada,dni_cliente,cod_emision,fecha_compra) VALUES ('"+entradaParaRegistrar.getCod_entrada() + "','"
